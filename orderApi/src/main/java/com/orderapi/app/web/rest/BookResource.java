...
import com.orderapi.app.domain.Book;
import com.orderapi.app.repository.BookRepository;
...
/**
 * REST controller for managing {@link com.orderapi.app.domain.Book}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BookResource {
    ...
    private static final String ENTITY_NAME = "orderApiBook";
