...
import com.orderapi.app.repository.ShoppingCartRepository;
...
/**
 * REST controller for managing {@link com.orderapi.app.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ShoppingCartResource {
    ...
    private static final String ENTITY_NAME = "orderApiShoppingCart";
