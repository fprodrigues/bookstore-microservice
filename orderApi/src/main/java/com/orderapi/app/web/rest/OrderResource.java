...
import com.orderapi.app.domain.Order;
import com.orderapi.app.repository.OrderRepository;
...
/**
 * REST controller for managing {@link com.orderapi.app.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderResource {
    ...
    private static final String ENTITY_NAME = "orderApiOrder";
