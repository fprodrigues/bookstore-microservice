...
import com.bookapi.app.repository.ShoppingCartRepository;
...
/**
 * REST controller for managing {@link com.bookapi.app.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ShoppingCartResource {
    ...
    private static final String ENTITY_NAME = "bookApiShoppingCart";
