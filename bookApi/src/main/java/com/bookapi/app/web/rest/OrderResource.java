...
import com.bookapi.app.domain.Order;
import com.bookapi.app.repository.OrderRepository;
...
/**
 * REST controller for managing {@link com.bookapi.app.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderResource {
    ...
    private static final String ENTITY_NAME = "bookApiOrder";
