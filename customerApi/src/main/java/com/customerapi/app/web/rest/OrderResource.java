...
import com.customerapi.app.domain.Order;
import com.customerapi.app.repository.OrderRepository;
...
/**
 * REST controller for managing {@link com.customerapi.app.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderResource {
    ...
    private static final String ENTITY_NAME = "customerApiOrder";
